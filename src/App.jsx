...
const App = () => {
  ...
  const LABELS = [
    ...
    { key: 'block-g',     label: 'Block G',     color: '#0d9488' },
    { key: 'block-h',     label: 'Block H',     color: '#84cc16' },
    { key: 'block-j',     label: 'Block J',     color: '#7c3aed' },
    { key: 'block-k',     label: 'Block K',     color: '#0369a1' },
    { key: 'block-l',     label: 'Block L',     color: '#b45309' },
